...
function handleIsVisible(state: boolean) {
  isVisible.value = state
}

// lifecycle hooks
onMounted(() => {
console.log(`The initial count is ${isVisible.value}.`)
})
    ...
    <header class="container absolute inset-x-0 top-8 z-50 flex justify-center" :class="isVisible ? 'sm:transform sm:opacity-100 duration-200 ease-in' : 'sm:transform sm:opacity-0 sm:-translate-y-4 duration-200 ease-in'">
      <nav class="flex items-center justify-between p-6 lg:px-8 bg-white w-2/3 rounded-full" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Informationen</a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Komfort</a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Gallerie</a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Aktivitäten</a>
        </div>
